...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    _row(
        ...
        gemini=_unverified(note="linked by the shared code; not tested for this runtime"),
        opencode=_unverified(note="linked by the shared code; not tested for this runtime"),
        deepcode=_gap(282),
        aider=_gap(282),
        shell=_na(_NO_MODEL),
    ),
