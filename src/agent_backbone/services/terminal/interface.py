"""Terminal services — async tmux operations and streaming."""
...
class TmuxService:
    ...
    async def send_keys(self, session: str, keys: str) -> bool:
        """Send a key name or escape sequence to a tmux session."""
