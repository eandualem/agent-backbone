...
from agent_backbone.api.deps import get_tmux_service
from agent_backbone.api.routes.stream import get_broker
from agent_backbone.services.terminal import StreamBroker


@pytest.fixture
def _reset_broker():
    """Reset the module-level broker singleton between tests."""
    from agent_backbone.api.broker import reset_broker
