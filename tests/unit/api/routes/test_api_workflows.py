...
from agent_backbone.api.deps import get_workflows_service
from agent_backbone.services.automation import WorkflowEntry
...
class TestCreateWorkflow:
    async def test_create_workflow_success(self, client, auth_headers, tmp_path):
        ...
        with patch("agent_backbone.api.routes.workflows._JSON_WORKFLOW_DIR", tmp_path):
