"""Tests for src/agent_backbone/services/tmux/_core.py — subprocess semaphore."""
...
_CORE = "agent_backbone.services.tmux._core"
...
class TestRunTmux:
    ...
    async def test_semaphore_limits_concurrency(self):
        ...
        import agent_backbone.services.tmux._core as core_mod
